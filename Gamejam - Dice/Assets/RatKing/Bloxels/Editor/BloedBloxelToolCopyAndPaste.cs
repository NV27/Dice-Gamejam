...
namespace RatKing {
	...
	public class BloedBloxelToolCopyAndPaste : BloedBloxelTool {
		...
		public bool AllowsPickingLevel { get { return true; } set { } }
		...
		public void OnSceneGUI(Bloed bloed, SceneView view) {
			...
			GUILayout.Label("<b><color=yellow>COPY&PASTER</color></b> Tool");
		...
		public void Hotkeys(Bloed bloed, Event evt) {
