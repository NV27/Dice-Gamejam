...
namespace RatKing {
	...
	public class CursorHoverMarker {
...
#if UNITY_6000_0_OR_NEWER
					var mat = Material.Instantiate(UnityEngine.Rendering.GraphicsSettings.defaultRenderPipeline.defaultParticleMaterial);
#else
		...
		public void Destroy() {
#if UNITY_6000_0_OR_NEWER
			if (UnityEngine.Rendering.GraphicsSettings.defaultRenderPipeline == null) { Camera.onPreCull -= DrawWithCamera; }
#else
